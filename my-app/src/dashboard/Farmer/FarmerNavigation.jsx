    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 relative">
        <div className="flex items-center justify-between">
          ...
          {/* Center Slogan */}
          <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 animate-floating">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div ref={messageRef} className="relative flex items-center">
              ...
              {messageOpen && (
                <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-md shadow-lg border z-50 animate-fadeInUp">
